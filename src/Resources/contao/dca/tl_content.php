...
$GLOBALS['TL_DCA']['tl_content']['palettes']['mmn_kenburns'] = '{type_legend},type,mm_kb_title;{source_legend},multiSRC;{image_legend},size;{protected_legend:hide},protected;{expert_legend:hide},guests;{invisible_legend:hide},invisible,start,stop;{mmn_ken_burns_legend},mmn_kb_timePerSlide,mmn_kb_maxZoom,mmn_kb_opacityTransistionTime,mmn_kb_shuffle';
...
$GLOBALS['TL_DCA']['tl_content']['fields']['mm_kb_title'] = [
	'label'                   => &$GLOBALS['TL_LANG']['tl_content']['mmn_kb_title'],
	'exclude'                 => true,
	'inputType'               => 'text',
